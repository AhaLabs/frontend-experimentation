...
import { Address, Asset, Contract, Keypair, Operation, StrKey, hash, scValToNative, xdr, nativeToScVal } from '@stellar/stellar-sdk';
import { fileURLToPath } from 'url';
import { AddressBook } from './address_book.ts';
import { config } from './env_config.ts';
import { createTxBuilder, invoke, invokeTransaction } from './tx.ts';
...
export async function deployContract(
  ...
  const constructorArgs = [
    ...
    nativeToScVal(tokenName),
    nativeToScVal(tokenSymb)
  ];
